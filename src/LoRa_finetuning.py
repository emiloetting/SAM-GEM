...
lora_cfg = LoraConfig(
    ...
    target_modules=['text_model.encoder.layer.0.attention.self.query', 
                    ...
                    'audio_model.audio_encoder.layers.0.blocks.0.attention.self.query', 
                    'audio_model.audio_encoder.layers.0.blocks.1.attention.self.query', 
                    'audio_model.audio_encoder.layers.1.blocks.0.attention.self.query', 
                    'audio_model.audio_encoder.layers.1.blocks.1.attention.self.query', 
                    'audio_model.audio_encoder.layers.2.blocks.0.attention.self.query', 
                    'audio_model.audio_encoder.layers.2.blocks.1.attention.self.query', 
                    'audio_model.audio_encoder.layers.2.blocks.2.attention.self.query', 
                    'audio_model.audio_encoder.layers.2.blocks.3.attention.self.query', 
                    'audio_model.audio_encoder.layers.2.blocks.4.attention.self.query', 
                    'audio_model.audio_encoder.layers.2.blocks.5.attention.self.query', 
                    'audio_model.audio_encoder.layers.3.blocks.0.attention.self.query', 
                    'audio_model.audio_encoder.layers.3.blocks.1.attention.self.query',
                    ...
                    'audio_model.audio_encoder.layers.0.blocks.0.attention.self.value', 
                    'audio_model.audio_encoder.layers.0.blocks.1.attention.self.value', 
                    'audio_model.audio_encoder.layers.1.blocks.0.attention.self.value', 
                    'audio_model.audio_encoder.layers.1.blocks.1.attention.self.value', 
                    'audio_model.audio_encoder.layers.2.blocks.0.attention.self.value', 
                    'audio_model.audio_encoder.layers.2.blocks.1.attention.self.value', 
                    'audio_model.audio_encoder.layers.2.blocks.2.attention.self.value', 
                    'audio_model.audio_encoder.layers.2.blocks.3.attention.self.value', 
